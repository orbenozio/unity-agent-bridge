...
// NullReferenceException as an example for the debugging loop: ask Claude to "read the
// console and fix it". Claude sees the stack trace via read_console / run_playmode and
// applies the minimal fix (a null check).
